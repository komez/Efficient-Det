...
if __name__=="__main__":
    ...
    os.makedirs(str(args.image_root_dir),exist_ok=True)
    ...
    json.dump(
        {"images": imagelist, "annotations": annotations, "categories": categories},
